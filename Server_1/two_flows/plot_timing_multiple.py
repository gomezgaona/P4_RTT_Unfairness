...
plt.plot(t[0:118], zeros_shift_1 + tput_flow_2[0:88], '#82AA45', linewidth=2, label='80ms')  #label='Fairness', marker ='o'
...
plt.set_xticks([0, 30, 60, 90, 120], ['0', '30', '60','90', '120'])
plt.fill_between(range(29,32), -5, 14,  alpha=0.25)
#Setting the y-axis limits
plt.set_ylim([-0.5,12.5])#throughput
plt.set_xlim([-1,len(tput_flow_1)+1])#fairness

fig.savefig(f"bbr_no_separation.pdf", bbox_inches='tight')
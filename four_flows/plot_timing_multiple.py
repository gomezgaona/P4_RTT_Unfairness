...
tput_flow_1 = extract_iperf_timing('results/out1.json')
tput_flow_2 = extract_iperf_timing('results/out2.json')
tput_flow_3 = extract_iperf_timing('results/out3.json')
tput_flow_4 = extract_iperf_timing('results/out4.json')
...
plt.set_xticks([0, 60, 120, 180, 240, 300], ['0', '60', '120', '180', '240', '300'])
plt.fill_between(range(59, 62), -5, 14,  alpha=0.25, color='lightsteelblue')
plt.fill_between(range(119, 122), -5, 14,  alpha=0.25, color='lightsteelblue')
plt.fill_between(range(179, 182), -5, 14,  alpha=0.25, color='lightsteelblue')
#plt.fill_between(range(239, 242), -5, 14,  alpha=0.25, color='lightsteelblue')

#Setting the y-axis limits
plt.set_ylim([-0.5,12.5])#throughput
plt.set_xlim([-1,len(tput_flow_1)+1])#fairness

fig.savefig(f"cubic_w_separation.pdf", bbox_inches='tight')
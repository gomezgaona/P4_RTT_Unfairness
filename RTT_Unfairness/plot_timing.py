...
tput_flow_1 = extract_iperf_timing('cubic_test/flow_no_separation_1ms.json')
tput_flow_2 = extract_iperf_timing('cubic_test/flow_no_separation_80ms.json')
...
plt.plot(t, zeros_shift + tput_flow_2, '#82AA45', linewidth=2, label='80ms')  #label='Fairness', marker ='o'
...
plt.set_ylim([0,13.9])#throughput
plt.set_xlim([-1,len(tput_flow_1)+1])#fairness

fig.savefig(f"cubic_wo_separation.pdf", bbox_inches='tight')